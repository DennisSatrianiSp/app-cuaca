...
fetch("http://api.openweathermap.org/data/2.5/weather?q=" + isi + "&APPID=80c6a7494cd5abb1d4ca35bd1f468b3a&units=metric").then((response) => response.json()).then((response) => {
